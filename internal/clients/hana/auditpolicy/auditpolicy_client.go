...
type AuditPolicyClient interface {
	Read(ctx context.Context, parameters *v1alpha1.AuditPolicyParameters) (*v1alpha1.AuditPolicyObservation, error)
	Create(ctx context.Context, parameters *v1alpha1.AuditPolicyParameters, args ...any) error
	...
	Delete(ctx context.Context, parameters *v1alpha1.AuditPolicyParameters) error
}
...
func (c Client) Create(ctx context.Context, parameters *v1alpha1.AuditPolicyParameters, args ...any) error {
