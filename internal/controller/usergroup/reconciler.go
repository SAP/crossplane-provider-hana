...
func (c *connector) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	c.log.Debug("Connecting to usergroup resource", "name", cr.Name)
...
func (c *external) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	...
	c.log.Debug("Observing usergroup resource", "name", cr.Name)
	...
	if err != nil {
		c.log.Debug("Error observing usergroup", "name", cr.Name, "error", err)
...
func (c *external) Create(ctx context.Context, mg resource.Managed) (managed.ExternalCreation, error) {
	...
	c.log.Debug("Creating usergroup with parameters",
		"usergroupName", parameters.UsergroupName,
	...
	if err != nil {
		c.log.Debug("Error creating usergroup", "name", cr.Name, "error", err)
...
func (c *external) Update(ctx context.Context, mg resource.Managed) (managed.ExternalUpdate, error) {
	...
	if cr.Status.AtProvider.DisableUserAdmin != parameters.DisableUserAdmin {
		c.log.Debug("Updating DisableUserAdmin setting",
			"name", cr.Name,
			"usergroupName", parameters.UsergroupName,
		...
		if err != nil {
			c.log.Debug("Error updating DisableUserAdmin", "name", cr.Name, "error", err)
	...
	if !parametersConfigured(observedParameters, desiredParameters) {
		...
		if err != nil {
			c.log.Debug("Error updating parameters", "name", cr.Name, "error", err)
			return managed.ExternalUpdate{}, fmt.Errorf(errUpdateUsergroup, err)
		}
		cr.Status.AtProvider.Parameters = parameters.Parameters
...
func (c *external) Delete(ctx context.Context, mg resource.Managed) (managed.ExternalDelete, error) {
	...
	if err != nil {
		c.log.Debug("Error deleting usergroup", "name", cr.Name, "error", err)
