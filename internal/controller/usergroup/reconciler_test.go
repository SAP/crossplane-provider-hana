...
import (
	...
	"github.tools.sap/cloud-orchestration/crossplane-provider-hana/internal/clients/hana/usergroup"
...
type mockClient struct {
	...
	MockCreate func(ctx context.Context, parameters *v1alpha1.UsergroupParameters, args ...any) error
...
func (m mockClient) Create(ctx context.Context, parameters *v1alpha1.UsergroupParameters, args ...any) error {
...
func TestObserve(t *testing.T) {
	...
	type fields struct {
		client hana.QueryClient[v1alpha1.UsergroupParameters, v1alpha1.UsergroupObservation]
		log    logging.Logger
	}
