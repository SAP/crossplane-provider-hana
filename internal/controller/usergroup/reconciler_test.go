...
type mockClient struct {
	MockRead                   func(ctx context.Context, parameters *v1alpha1.UsergroupParameters) (observed *v1alpha1.UsergroupObservation, err error)
	MockCreate                 func(ctx context.Context, parameters *v1alpha1.UsergroupParameters) error
	MockDelete                 func(ctx context.Context, parameters *v1alpha1.UsergroupParameters) error
...
func (m mockClient) Read(ctx context.Context, parameters *v1alpha1.UsergroupParameters) (observed *v1alpha1.UsergroupObservation, err error) {
	return m.MockRead(ctx, parameters)
}

func (m mockClient) Create(ctx context.Context, parameters *v1alpha1.UsergroupParameters) error {
	return m.MockCreate(ctx, parameters)
}

func (m mockClient) Delete(ctx context.Context, parameters *v1alpha1.UsergroupParameters) error {
	return m.MockDelete(ctx, parameters)
}

func (m mockClient) UpdateDisableUserAdmin(ctx context.Context, parameters *v1alpha1.UsergroupParameters) error {
	return m.MockUpdateDisableUserAdmin(ctx, parameters)
}

func (m mockClient) UpdateParameters(ctx context.Context, parameters *v1alpha1.UsergroupParameters, parametersToSet map[string]string) error {
	return m.MockUpdateParameters(ctx, parameters, parametersToSet)
}
...
func TestConnect(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"ErrNotUserGroup": {
			...
			want: errors.New(errNotUsergroup),
		},
...
func TestObserve(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"ErrObserve": {
			reason: "Any errors encountered while observing the UserGroup should be returned",
			fields: fields{
				client: mockClient{
					MockRead: func(ctx context.Context, parameters *v1alpha1.UsergroupParameters) (observed *v1alpha1.UsergroupObservation, err error) {
						return nil, errBoom
			...
			want: want{
				err: fmt.Errorf(errSelectUsergroup, errBoom),
			},
		},
		"Success": {
			reason: "No error should be returned when we successfully observe a UserGroup",
			fields: fields{
				client: mockClient{
					MockRead: func(ctx context.Context, parameters *v1alpha1.UsergroupParameters) (observed *v1alpha1.UsergroupObservation, err error) {
						return &v1alpha1.UsergroupObservation{
							UsergroupName: "",
						}, nil
					},
				},
...
func TestCreate(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"ErrCreate": {
			...
			want: want{
				err: fmt.Errorf(errCreateUsergroup, errBoom),
			},
		},
		"Success": {
...
func TestDelete(t *testing.T) {
	...
	cases := map[string]struct {
		...
		"ErrDelete": {
			...
			want: want{
				err: fmt.Errorf(errDropUsergroup, errBoom),
			},
		},
		"Success": {
