...
type mockAuditPolicyClient struct {
	...
	MockCreate              func(ctx context.Context, parameters *v1alpha1.AuditPolicyParameters, args ...any) error
...
func (m mockAuditPolicyClient) Create(ctx context.Context, parameters *v1alpha1.AuditPolicyParameters, args ...any) error {
