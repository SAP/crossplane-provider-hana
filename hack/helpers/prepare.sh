...
sed -i.bak "s/crossplane-provider-template/crossplane-provider-${ProviderNameLower}/g" .golangci.yml
sed -i.bak "s/provider-template/provider-${ProviderNameLower}/g" .pipeline/config.yml
sed -i.bak "s/provider-template/provider-${ProviderNameLower}/g" .pipeline/extensions/Central\ Build.groovy
...
git mv "cluster/images/crossplane-provider-template" "cluster/images/crossplane-provider-${ProviderNameLower}"
git mv "cluster/images/crossplane-provider-template-controller" "cluster/images/crossplane-provider-${ProviderNameLower}-controller"